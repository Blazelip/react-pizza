  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <button disabled={count <= 1} onClick={onClickMinus} className={clsx('button button--outline button--circle cart__item-count-minus', {'cart__item-count--disabled': count <= 1})}>
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
